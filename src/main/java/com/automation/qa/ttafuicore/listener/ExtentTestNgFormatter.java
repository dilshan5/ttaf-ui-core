...
import com.automation.qa.ttafuicore.reporter.EmailReporter;
import com.automation.qa.ttafuicore.reporter.NodeName;
...
public class ExtentTestNgFormatter implements ISuiteListener, ITestListener, IInvokedMethodListener, IReporter {
    ...
    public void onStart(ISuite iSuite) {
        ...
        LOGGER.info("About to begin executing Suite " + iSuite.getName());
    }
    ...
    public void onFinish(ISuite iSuite) {
        LOGGER.info("About to end executing Suite " + iSuite.getName());
    }
    ...
    public void afterInvocation(IInvokedMethod iInvokedMethod, ITestResult iTestResult) {
        if (iInvokedMethod.isTestMethod()) {
            ...
            ExtentTest testContext = (ExtentTest) iTestContext.getAttribute("testContext");
            ExtentTest test = testContext.createNode(Constant.SCENARIO_NAME);
            iTestResult.setAttribute("test", test);

            ExtentTest test1 = (ExtentTest) iTestResult.getAttribute("test");
